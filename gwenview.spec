...
Source0  : https://download.kde.org/stable/release-service/20.08.2/src/gwenview-20.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.2/src/gwenview-20.08.2.tar.xz.sig
...
%prep
%setup -q -n gwenview-20.08.2
cd %{_builddir}/gwenview-20.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602631078
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/gwenview-20.08.2/COPYING %{buildroot}/usr/share/package-licenses/gwenview/a21ac62aee75f8fcb26b1de6fc90e5eea271854c
cp %{_builddir}/gwenview-20.08.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/gwenview/1bd373e4851a93027ba70064bd7dbdc6827147e1
pushd clr-build
%make_install
popd
%find_lang gwenview
