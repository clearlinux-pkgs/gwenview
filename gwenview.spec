...
Version  : 18.12.3
Release  : 7
URL      : https://download.kde.org/stable/applications/18.12.3/src/gwenview-18.12.3.tar.xz
Source0  : https://download.kde.org/stable/applications/18.12.3/src/gwenview-18.12.3.tar.xz
Source99 : https://download.kde.org/stable/applications/18.12.3/src/gwenview-18.12.3.tar.xz.sig
...
Patch1: 0001-Fix-mem-leak-found-by-asan.patch
Patch2: 0002-Use-forward-declaration-for-Exiv2-Image-port-to-std-.patch
Patch3: 0003-Compile-more-files-with-enabled-exceptions-required-.patch
Patch4: build.patch
...
export LANG=C
export SOURCE_DATE_EPOCH=1551992889
mkdir -p clr-build
pushd clr-build
...
cp COPYING.DOC %{buildroot}/usr/share/package-licenses/gwenview/COPYING.DOC
pushd clr-build
%make_install
popd
%find_lang gwenview
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/gwenview/COPYING
/usr/share/package-licenses/gwenview/COPYING.DOC
