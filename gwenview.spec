...
Version  : 21.08.3
Release  : 36
URL      : https://download.kde.org/stable/release-service/21.08.3/src/gwenview-21.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.08.3/src/gwenview-21.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.3/src/gwenview-21.08.3.tar.xz.sig
...
%prep
%setup -q -n gwenview-21.08.3
cd %{_builddir}/gwenview-21.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636061867
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/gwenview-21.08.3/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/gwenview/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/gwenview-21.08.3/COPYING %{buildroot}/usr/share/package-licenses/gwenview/a21ac62aee75f8fcb26b1de6fc90e5eea271854c
cp %{_builddir}/gwenview-21.08.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/gwenview/1bd373e4851a93027ba70064bd7dbdc6827147e1
pushd clr-build
%make_install
popd
%find_lang gwenview
