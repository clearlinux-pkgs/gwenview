...
Version  : 21.12.0
Release  : 37
URL      : https://download.kde.org/stable/release-service/21.12.0/src/gwenview-21.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/gwenview-21.12.0.tar.xz
...
%prep
%setup -q -n gwenview-21.12.0
cd %{_builddir}/gwenview-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639624897
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/gwenview-21.12.0/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/gwenview/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/gwenview-21.12.0/COPYING %{buildroot}/usr/share/package-licenses/gwenview/a21ac62aee75f8fcb26b1de6fc90e5eea271854c
cp %{_builddir}/gwenview-21.12.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/gwenview/1bd373e4851a93027ba70064bd7dbdc6827147e1
pushd clr-build
%make_install
popd
%find_lang gwenview
