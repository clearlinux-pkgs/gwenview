...
Version  : 20.08.3
Release  : 26
URL      : https://download.kde.org/stable/release-service/20.08.3/src/gwenview-20.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.08.3/src/gwenview-20.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.3/src/gwenview-20.08.3.tar.xz.sig
...
%prep
%setup -q -n gwenview-20.08.3
cd %{_builddir}/gwenview-20.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604593517
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/gwenview-20.08.3/COPYING %{buildroot}/usr/share/package-licenses/gwenview/a21ac62aee75f8fcb26b1de6fc90e5eea271854c
cp %{_builddir}/gwenview-20.08.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/gwenview/1bd373e4851a93027ba70064bd7dbdc6827147e1
pushd clr-build
%make_install
popd
%find_lang gwenview
